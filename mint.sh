...
#---------------------------------------------
# check if apache is installed before setting ufw to "Apache Secure"
# 
#---------------------------------------------
...
installPrograms() {
    ...
    for program in libpam-pwquality chkrootkit clamav rkhunter sudo ufw auditd rsyslog systemd-journal-remote; do
...
gnome-terminal -- bash -c "groupUsers; secureUsers; prohibitedMedia; exec bash"
